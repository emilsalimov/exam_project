    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentResutls", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentResutls_Answers_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentResutls_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentResutls_StudentExams_StudentExamId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentResutls_AnswerId",
                table: "StudentResutls",
                column: "AnswerId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StudentResutls_QuestionId",
                table: "StudentResutls",
                column: "QuestionId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StudentResutls_StudentExamId",
                table: "StudentResutls",
